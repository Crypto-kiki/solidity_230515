...
contract Q3 {
    ...
    function reCharge() public payable {
        ...
        /*
        prePaid 1이더 이상, msg.value 1이더 turnedOff -> o
        prePaid 1이더 이하, msg.value 1이더 turnedOff -> o
        prePaid 1이더 이하, msg.value 1이더 이하 turnedOff -> x
        prePaid 1이더 이상, msg.value 1이더 turnedOff(x) -> x
        prePaid 1이더 이하, msg.value 1이더 turnedOff(x) -> x
        prePaid 1이더 이하, msg.value 1이더 이하 turnedOff(x) -> x
        */
